...
public class Seminario {
    ...
    public Seminario(LocalDate fechaExposicion, Aprobacion aprobacion) //Sobrecargando al metodo con el this()
    {
        this.fechaExposicion = fechaExposicion;
        this.aprobacion = aprobacion;
    }
    
    public Seminario(LocalDate fechaExposicion, String observaciones, Aprobacion aprobacion) 
    {
